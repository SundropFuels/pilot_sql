...
CREATE TABLE IF NOT EXISTS pilot_run_db.lv_data_tbl(
  ...
  XV_932049 TINYINT(1),
  XV_932052 TINYINT(1),
  XV_932180ZSC TINYINT(1),
  XV_932180ZSO TINYINT(1),
...
CREATE  TABLE IF NOT EXISTS pilot_run_db.glossary_tbl (
  ...
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
  ...
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status)
    VALUES ('E_STOP', 'e_stop', 'E-Stop', 'boolean', 1);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
  ...
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('PT_1450', 'pressure_roto_feed_exit', 'Pressure at exit of Roto-Feed', 'psig', 0, 9005);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('PT_924015', 'pressure_gasifier_furnace', 'Gasifier furnace box pressure', 'psig', 0, 9010);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
  ...
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('TE_983098', 'temp_superheater_relief_1', 'Superheater relief valve temperature', 'C', 0, 9006);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('TE_983099', 'temp_superheater_relief_2', 'Superheater relief valve temperature', 'C', 0, 9006);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
  ...
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('TI_924002A', 'temp_lower_bucket_seal_skin_a', 'Lower bucket seal skin temperature A', 'C', 0, 9007);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('TI_924002B', 'temp_lower_bucket_seal_skin_b', 'Lower bucket seal skin temperature B', 'C', 0, 9007);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('TI_924002C', 'temp_lower_bucket_seal_skin_c', 'Lower bucket seal skin temperature C', 'C', 0, 9007);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('TI_924002D', 'temp_lower_bucket_seal_skin_d', 'Lower bucket seal skin temperature D', 'C', 0, 9007);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
  ...
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('XV_932180ZSC', 'valve_quench_isolation_close', 'Gasifier/quench isolation fast acting valve Proof of close', 'boolean', 1, 9009);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
    VALUES ('XV_932180ZSO', 'valve_quench_isolation_open', 'Gasifier/quench isolation fast acting valve Proof of open', 'boolean', 1, 9008);
  INSERT INTO pilot_run_db.glossary_tbl (tag_number, simple_name, description, units, log_status, pid_sheet)
...
SELECT
  ...
  lv_data_tbl.AG_1407_FAULT,
  lv_data_tbl.AG_1407_OP,
  lv_data_tbl.AI_922021,
  lv_data_tbl.AI_932050,
  lv_data_tbl.DPI_922019,
  lv_data_tbl.DPI_922021,
  lv_data_tbl.DPI_922022,
  lv_data_tbl.DPI_932014,
  lv_data_tbl.DPI_932015,
  lv_data_tbl.DPI_932070,
  lv_data_tbl.DPI_932071,
  lv_data_tbl.DPI_932302,
  lv_data_tbl.DPI_936014,
  lv_data_tbl.DPI_936015,
  lv_data_tbl.DPIT_922007,
  lv_data_tbl.E_STOP,
  lv_data_tbl.FI_1423,
  lv_data_tbl.FI_1445,
  lv_data_tbl.FI_932006,
  lv_data_tbl.FI_932036,
  lv_data_tbl.FIC_1442_OP,
  lv_data_tbl.FIC_1442_PV,
  lv_data_tbl.FIC_1442_SP,
  lv_data_tbl.FIC_983006_OP,
  lv_data_tbl.FIC_983006_PV,
  lv_data_tbl.FIC_983006_SP,
  lv_data_tbl.FIC_986009_OP,
  lv_data_tbl.FIC_986009_PV,
  lv_data_tbl.FIC_986009_SP,
  lv_data_tbl.FIC_989011_PV,
  lv_data_tbl.FIC_989011_SP,
  lv_data_tbl.FIC_990014_PV,
  lv_data_tbl.FIC_990014_SP,
  lv_data_tbl.HS_932018,
  lv_data_tbl.HS_932025,
  lv_data_tbl.LCV_932024,
  lv_data_tbl.LE_932004,
  lv_data_tbl.LSH_1405,
  lv_data_tbl.LSH_932021,
  lv_data_tbl.LSL_1406,
  lv_data_tbl.PC_983001,
  lv_data_tbl.PCV_1420_OP,
  lv_data_tbl.PCV_1420_PV,
  lv_data_tbl.PCV_1420_SP,
  lv_data_tbl.PDI_1445,
  lv_data_tbl.PI_1442,
  lv_data_tbl.PI_1445,
  lv_data_tbl.PI_326,
  lv_data_tbl.PI_924502,
  lv_data_tbl.PI_924XXX,
  lv_data_tbl.PI_932019,
  lv_data_tbl.PI_932042,
  lv_data_tbl.PI_932057,
  lv_data_tbl.PI_932503,
  lv_data_tbl.PI_936010,
  lv_data_tbl.PI_936012,
  lv_data_tbl.PI_936052,
  lv_data_tbl.PI_983003,
  lv_data_tbl.PI_983005,
  lv_data_tbl.PIC_932005_OP,
  lv_data_tbl.PIC_932005_PV,
  lv_data_tbl.PIC_932005_SP,
  lv_data_tbl.PIC_932030_OP,
  lv_data_tbl.PIC_932030_PV,
  lv_data_tbl.PIC_932030_SP,
  lv_data_tbl.PS_1404,
  lv_data_tbl.PS_1405,
  lv_data_tbl.PS_1406,
  lv_data_tbl.PS_932044,
  lv_data_tbl.PSL_986611,
  lv_data_tbl.PSL_986902,
  lv_data_tbl.PT_1406,
  lv_data_tbl.PT_1450,
  lv_data_tbl.PT_924015,
  lv_data_tbl.TE_922022,
  lv_data_tbl.TE_932016,
  lv_data_tbl.TE_983301,
  lv_data_tbl.TE_983302,
  lv_data_tbl.TE_983303,
  lv_data_tbl.TE_983304,
  lv_data_tbl.TE_983305,
  lv_data_tbl.TE_983098,
  lv_data_tbl.TE_983099,
  lv_data_tbl.TI_323,
  lv_data_tbl.TI_324A,
  lv_data_tbl.TI_324B,
  lv_data_tbl.TI_922020,
  lv_data_tbl.TI_924001,
  lv_data_tbl.TI_924002A,
  lv_data_tbl.TI_924002B,
  lv_data_tbl.TI_924002C,
  lv_data_tbl.TI_924002D,
  lv_data_tbl.TI_924003,
  lv_data_tbl.TI_924004,
  lv_data_tbl.TI_924012,
  lv_data_tbl.TI_924013,
  lv_data_tbl.TI_924014,
  lv_data_tbl.TI_924032,
  lv_data_tbl.TI_924034,
  lv_data_tbl.TI_924036,
  lv_data_tbl.TI_924101,
  lv_data_tbl.TI_924503,
  lv_data_tbl.TI_932001,
  lv_data_tbl.TI_932003,
  lv_data_tbl.TI_932007A,
  lv_data_tbl.TI_932007B,
  lv_data_tbl.TI_932011,
  lv_data_tbl.TI_932017,
  lv_data_tbl.TI_932018,
  lv_data_tbl.TI_932023,
  lv_data_tbl.TI_932035,
  lv_data_tbl.TI_932051,
  lv_data_tbl.TI_932056,
  lv_data_tbl.TI_932101,
  lv_data_tbl.TI_932151,
  lv_data_tbl.TI_932152,
  lv_data_tbl.TI_932501,
  lv_data_tbl.TI_932502,
  lv_data_tbl.TI_936001,
  lv_data_tbl.TI_936002,
  lv_data_tbl.TI_936003,
  lv_data_tbl.TI_936004,
  lv_data_tbl.TI_936005,
  lv_data_tbl.TI_936006,
  lv_data_tbl.TI_936007,
  lv_data_tbl.TI_936008,
  lv_data_tbl.TI_936009,
  lv_data_tbl.TI_936102,
  lv_data_tbl.TI_983004,
  lv_data_tbl.TI_983013,
  lv_data_tbl.TI_983027,
  lv_data_tbl.TI_983036,
  lv_data_tbl.TI_986065,
  lv_data_tbl.TI_989015,
  lv_data_tbl.TIC_932007_OP,
  lv_data_tbl.TIC_932007_PV,
  lv_data_tbl.TIC_932007_SP,
  lv_data_tbl.TIC_932053_OP,
  lv_data_tbl.TIC_932053_PV,
  lv_data_tbl.TIC_932053_SP,
  lv_data_tbl.TIC_986610_OP,
  lv_data_tbl.TIC_986610_PV,
  lv_data_tbl.TIC_986610_SP,
  lv_data_tbl.TY_924021_SP,
  lv_data_tbl.TY_983014_SP,
  lv_data_tbl.WIC_1402_PV,
  lv_data_tbl.WIT_1406,
  lv_data_tbl.XV_1401,
  lv_data_tbl.XV_1404,
  lv_data_tbl.XV_1405,
  lv_data_tbl.XV_1406,
  ...
  lv_data_tbl.XV_1445,
  lv_data_tbl.XV_1447,
  lv_data_tbl.XV_1448A,
  lv_data_tbl.XV_1448B,
  lv_data_tbl.XV_1449A,
  lv_data_tbl.XV_1449B,
  lv_data_tbl.XV_1449C,
  lv_data_tbl.XV_1450,
  lv_data_tbl.XV_922016,
  lv_data_tbl.XV_932018,
  lv_data_tbl.XV_932025,
  lv_data_tbl.XV_932028,
  lv_data_tbl.XV_932046,
  lv_data_tbl.XV_932049,
  lv_data_tbl.XV_932052,
  lv_data_tbl.XV_932180ZSC,
  lv_data_tbl.XV_932180ZSO,
  lv_data_tbl.XV_932301A,
  lv_data_tbl.XV_932301B,
  lv_data_tbl.XV_932301C,
  lv_data_tbl.XV_932504,
  lv_data_tbl.XV_932505,
  lv_data_tbl.XV_936001A,
  lv_data_tbl.XV_936001B,
  lv_data_tbl.XV_936002A,
  lv_data_tbl.XV_936002B,
  lv_data_tbl.XV_936050,
  lv_data_tbl.XV_936058,
  lv_data_tbl.XV_936080,
  lv_data_tbl.XV_983012,
  lv_data_tbl.XV_983013,
  lv_data_tbl.XV_983065,
  lv_data_tbl.XV_986006,
  lv_data_tbl.XV_986016,
  lv_data_tbl.XV_986024,
  lv_data_tbl.XV_986034,
  lv_data_tbl.XV_986901,
  lv_data_tbl.XV_989012,
  lv_data_tbl.XV_990013,
  lv_data_tbl.ZSC_922016,
  lv_data_tbl.ZSC_932504,
  lv_data_tbl.ZSC_932505,
  lv_data_tbl.ZSC_936001A,
  lv_data_tbl.ZSC_936001B,
  lv_data_tbl.ZSC_936002A,
  lv_data_tbl.ZSC_936002B,
  lv_data_tbl.ZSC_983012,
  lv_data_tbl.ZSC_983013,
  lv_data_tbl.ZSO_922016,
  lv_data_tbl.ZSO_983012,
  lv_data_tbl.ZSO_983013
  FROM lv_data_tbl LEFT JOIN
  ms_data_tbl ON
  lv_data_tbl.ts = ms_data_tbl.ts
  LEFT JOIN gc_data_tbl ON
  lv_data_tbl.ts = gc_data_tbl.ts;
